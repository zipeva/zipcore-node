...
module.exports.services.Zip = require('./lib/services/zipd');
...
module.exports.cli.zipcore = require('./lib/cli/zipcore');
module.exports.cli.zipcored = require('./lib/cli/zipcored');

module.exports.lib = require('@zipeva/zipcore-lib');
